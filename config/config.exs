...
config :becomics, BecomicsWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: BecomicsWeb.ErrorHTML, json: BecomicsWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Becomics.PubSub,
  live_view: [signing_salt: "oo5KXzGm"]
...
config :becomics, Becomics.Mailer, adapter: Swoosh.Adapters.Local
